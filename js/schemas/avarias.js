...
export const SCHEMA_AVARIAS = {
    ...
    fields: [
        ...
        { name: "vista_lateral_esquerda", label: "Vista lateral esquerda", type: "file", accept: "image/*", capture: "environment" , maxSizeMB: 10, storageFolder: "vista_lateral_esquerda", storageBucket: "veiculos"},
        { name: "vista_teto", label: "Vista do teto", type: "file", accept: "image/*", capture: "environment" , maxSizeMB: 10, storageFolder: "vista_teto", storageBucket: "veiculos"},
